package com.hexalitics.countrypicker.ui
...
import com.hexalitics.countrypicker.R
import com.hexalitics.countrypicker.databinding.LayoutCodePickerBinding
import com.hexalitics.countrypicker.fragment.BottomCountryPickerFragment
import com.hexalitics.countrypicker.model.CountryItem
import androidx.fragment.app.FragmentActivity
import com.hexalitics.countrypicker.utils.Constants.list
import com.hexalitics.countrypicker.utils.setCountryList
import java.util.*
...
class CountryCodePicker(context: Context, attributeSet: AttributeSet) :
    ...
    private var callback: OnCountrySelected? = null
    ...
    fun setCallBack(callback: OnCountrySelected) {
...
interface OnCountrySelected {
    fun onCountrySelected(item: CountryItem?)
}